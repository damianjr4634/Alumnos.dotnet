...
/// <summary>
/// Modificación de alumno (sucesor del UPDATE de FrmAltaAlumno). El par
/// (CodigoCarrera, Codigo) identifica al alumno y no es editable acá: el cambio
/// de DNI o libro matriz tiene su propio caso de uso (SP XXX_CAMBIA_DNI_LM).
/// A diferencia del alta, la edición sí permite marcar la baja (CbxBaja).
/// </summary>
public sealed record ActualizarAlumnoCommand
{
