...
/// <summary>
/// Validación de la regularización. Réplica de los chequeos de la UI legacy: las notas
/// del cursado van en [1,10], vacías, o el centinela 99 (ausente); las faltas no son
/// negativas.
/// </summary>
public sealed class ConfirmarRegularizacionValidator : AbstractValidator<ConfirmarRegularizacionCommand>
{
    public ConfirmarRegularizacionValidator()
    {
        ...
        RuleForEach(c => c.Filas).ChildRules(f =>
        {
            ...
            f.RuleFor(x => x.TpEva).Must(NotaValida).WithMessage("El 1° parcial debe estar entre 1 y 10 (o 99 = ausente).");
            f.RuleFor(x => x.TpEva2).Must(NotaValida).WithMessage("El 2° parcial debe estar entre 1 y 10 (o 99 = ausente).");
