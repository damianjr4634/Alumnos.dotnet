...
public sealed class ActualizarDocenteValidator : AbstractValidator<ActualizarDocenteCommand>
{
    public ActualizarDocenteValidator()
    {
        RuleFor(c => c.Codigo)
            .NotEmpty().WithMessage("Código de docente inválido.")
