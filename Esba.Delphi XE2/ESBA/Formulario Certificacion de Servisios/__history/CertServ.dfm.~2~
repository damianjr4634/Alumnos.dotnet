object FrmCertServ: TFrmCertServ
  Left = 177
  Top = 102
  BorderStyle = bsDialog
  Caption = 'Certificacion de servicios'
  ClientHeight = 516
  ClientWidth = 558
  Color = clBtnFace
  ...
  object GroupBox1: TGroupBox
    ...
    object Grilla: TDBGrid
      ...
      Columns = <
        item
          Expanded = False
          FieldName = 'COD_PROFES'
          Title.Caption = 'Codigo de Profesor'
          Visible = True
        end
        item
          Expanded = False
        ...
        item
          Expanded = False
          FieldName = 'SIGLA'
          Title.Caption = 'Codigo de materia'
          Visible = True
        end
        item
          Expanded = False
  ...
  object GroupBox2: TGroupBox
    ...
    object ComboCarreras: TComboBox
      Left = 80
      Top = 17
      Width = 76
      Height = 21
  ...
  object GroupBox3: TGroupBox
    ...
    object CodigoProfesor: TEdit
      Left = 52
      Top = 13
      Width = 45
      Height = 21
      TabOrder = 0
      OnKeyPress = CodigoProfesorKeyPress
    end
    object comboProfesor: TComboBox
      Left = 109
      Top = 13
      Width = 281
      Height = 21
      Style = csDropDownList
      TabOrder = 1
      OnChange = comboProfesorChange
      OnClick = comboProfesorChange
    end
    object VerHist: TBitBtn
      Left = 468
      Top = 11
      Width = 75
      Height = 25
      ...
      NumGlyphs = 2
      TabOrder = 2
      OnClick = VerHistClick
    end
  end
  object DataSource1: TDataSource
    DataSet = CustomerData.IbSertCerv
    Left = 376
    Top = 200
  end
end
